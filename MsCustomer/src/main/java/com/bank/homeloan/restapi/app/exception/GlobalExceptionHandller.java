...
public class GlobalExceptionHandller {
	...
	public ResponseEntity<APIError> handleMethodArgumentNotValidException(MethodArgumentNotValidException enf, HttpServletRequest hsr){
	...
	public ResponseEntity<APIError> handleCustomerApplicationsNotFoundException(CustomerApplicationsNotFoundException enf, HttpServletRequest hsr){
		APIError ap=new APIError();
		ap.setStatuscode(HttpStatus.NOT_FOUND.value());
		ap.setPath(hsr.getRequestURI());
		ap.setMessage(enf.getMessage());
